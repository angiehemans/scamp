...
const ctx = {
    ...
    quietWindow: { extend: () => { }, isOpen: () => false },
    cancelWriteTimer: () => { },
    scheduleQuietResume: () => { },
};
const edit = (label) => {
...
const cardText = () => Object.values(useCanvasStore.getState().componentTrees['Card']?.elements ?? {}).map((e) => e.text);
