...
`;
const apply = (base, next) => applyEdits(base, tsxEdits(base, next));
...
describe('tsxRegionChanges', () => {
    ...
    it('inserts a component import after the styles import', () => {
        const next = GENERATED.replace("import styles from './Card.module.css';\n", "import styles from './Card.module.css';\nimport LinkCard from '@/components/LinkCard/LinkCard';\n");
    ...
    it('removes the import of a component no longer used', () => {
        const withImport = GENERATED.replace("import styles from './Card.module.css';\n", "import styles from './Card.module.css';\nimport LinkCard from '@/components/LinkCard/LinkCard';\n");
