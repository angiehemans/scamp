...
const parentWith = (display) => element({ id: 'parent', parentId: null, display });
describe('preserveDrawnSize', () => {
    ...
    it('leaves a grid child alone', () => {
        ...
        expect(preserveDrawnSize(element(), parentWith('grid')).customProperties).toEqual({});
    });
    it('leaves a child of a plain container alone', () => {
        expect(preserveDrawnSize(element(), parentWith('none')).customProperties).toEqual({});
    });
