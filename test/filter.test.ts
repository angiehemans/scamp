...
const BLUR: FilterDef = { kind: 'blur', value: 4 };
const BRIGHTNESS: FilterDef = { kind: 'brightness', value: 120 };
const GRAYSCALE: FilterDef = { kind: 'grayscale', value: 50 };
const HUE: FilterDef = { kind: 'hue-rotate', value: 90 };
