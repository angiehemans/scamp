...
import { formatTransformList, parseTransformFunction, parseTransformList, } from '@lib/parsers';
...
const cssFor = (a1b2) => generateCode({
    elements: { [ROOT_ELEMENT_ID]: makeRoot(['a1b2']), a1b2: makeRect('a1b2', a1b2) },
    rootId: ROOT_ELEMENT_ID,
    pageName: 'home',
}).css;
const block = (css) => css.match(/\.rect_a1b2 \{([^}]*)\}/s)?.[1] ?? '';
...
`;
const parseWith = (decls) => parseCode(TSX, `.root {\n  width: 100%;\n}\n\n.rect_a1b2 {\n${decls}}\n`).elements['a1b2'];
