...
import { clampZoom, MAX_ZOOM, MIN_ZOOM, nextZoomFromWheel, stepZoom, ZOOM_BUTTON_STEP, ZOOM_SENSITIVITY, } from '../src/renderer/lib/zoom';
describe('clampZoom', () => {
...
describe('nextZoomFromWheel', () => {
    ...
    it('applies the exponential mapping with ZOOM_SENSITIVITY', () => {
        expect(nextZoomFromWheel(1, -50)).toBeCloseTo(Math.exp(50 * ZOOM_SENSITIVITY), 5);
    });
