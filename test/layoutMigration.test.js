...
import { DEFAULT_BODY_FONT_FAMILY, DEFAULT_THEME_CSS, defaultLayoutTsx, LEGACY_LAYOUT_TEMPLATES, } from '../src/shared/agentMd';
...
describe('defaultLayoutTsx — body reset', () => {
    it("emits margin: 0 and minHeight: '100vh' on the <body>", () => {
        ...
        expect(out).toContain("<body style={{ margin: 0, minHeight: '100vh' }}>{children}</body>");
    });
