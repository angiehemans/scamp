...
`;
const write = (baseTsx) => tsxWriteFor({ baseTsx, generatedTsx: PAGE, css: CSS, breakpoints: [], isComponent: false });
describe('tsxWriteFor', () => {
    ...
    it('leaves a file alone when only its formatting differs', () => {
        const formatted = PAGE.replace('    <div data-scamp-id="root" className={styles.root} />', '    <div\n      data-scamp-id="root"\n      className={styles.root}\n    />');
