...
describe('hoistNamedSlots', () => {
    it('hoists a single named-slot prop on a self-closing instance', () => {
        const tsx = '<Card data-scamp-instance-id="inst_x" left={<div data-scamp-id="rect_a" className={styles.rect_a}>Hi</div>} />';
        const out = hoistNamedSlots(tsx);
        expect(out).toContain('<Card data-scamp-instance-id="inst_x">');
        expect(out).toContain('<div data-scamp-slot="left" data-scamp-id="rect_a" className={styles.rect_a}>Hi</div>');
    ...
    it('hoists two named slots', () => {
        const tsx = '<Split data-scamp-instance-id="inst_x" left={<div data-scamp-id="rect_l">L</div>} right={<div data-scamp-id="rect_r">R</div>} />';
        const out = hoistNamedSlots(tsx);
    ...
    it('marks each top-level element of a fragment slot value', () => {
        const tsx = '<Card data-scamp-instance-id="inst_x" body={<><div data-scamp-id="rect_a">A</div><div data-scamp-id="rect_b">B</div></>} />';
        const out = hoistNamedSlots(tsx);
    ...
    it('leaves string props and non-element braced props untouched', () => {
        const tsx = '<Card data-scamp-instance-id="inst_x" label="Hello" className={styles.card} />';
    ...
    it('handles nested elements inside a named slot value', () => {
        const tsx = '<Card data-scamp-instance-id="inst_x" header={<div data-scamp-id="rect_a"><span data-scamp-id="text_b">Deep</span></div>} />';
        const out = hoistNamedSlots(tsx);
