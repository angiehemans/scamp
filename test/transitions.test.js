...
describe('transitions: generator', () => {
    ...
    it('joins multiple transitions with commas', () => {
        ...
        expect(css).toContain('transition: opacity 200ms ease, transform 300ms ease-in-out 100ms;');
    });
});
...
describe('transitions: round-trip', () => {
    it('round-trips through generateCode → parseCode', () => {
        ...
        expect(parsed.elements['a1b2']?.transitions).toEqual(elements['a1b2']?.transitions);
    });
});
