...
test.describe('elements: SVG import', () => {
  test('image tool inlines an SVG with a viewBox (not an <img>)', async ({
    window,
    app,
    project,
  }) => {
  ...
  test('an imported SVG nests inside the selected container', async ({
    window,
    app,
    project,
  }) => {
  ...
  test('editing an SVG colour persists to disk', async ({
    window,
    app,
    project,
  }) => {
  ...
  test('editing the Current color of a currentColor SVG persists to disk', async ({
    window,
    app,
    project,
  }) => {
