...
test.describe('component sidebar thumbnail', () => {
    test('a component save writes a thumbnail with the component in it', async ({ window, project, }) => {
        ...
        const file = path.join(project.dir, '.scamp', 'component-thumbs', 'Card.png');
        await expect
