...
test.describe('color picker: hex input', () => {
    test('typing a 6-digit hex into the Background color input writes it to CSS', async ({ window, project, }) => {
        ...
        expect(css).toMatch(new RegExp(`\\.${className}[^}]*background:\\s*#11aabb`, 'si'));
    });
});
