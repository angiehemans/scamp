...
export const propertiesPanel = (page) => page.locator('[data-testid="properties-panel"]');
/** A named `<Section>` inside the properties panel. */
export const panelSection = (page, title) => propertiesPanel(page).locator(`[data-panel-section="${title}"]`);
/**
 ...
 * `PrefixSuffixInput`.
 */
export const panelInputByPrefix = (page, sectionTitle, prefix) => panelSection(page, sectionTitle)
 ...
 */
export const drawAndSelectRect = async (page, from, to) => {
 ...
 */
export const commitInput = async (input, value) => {
 ...
 */
export const setPanelMode = async (page, mode) => {
