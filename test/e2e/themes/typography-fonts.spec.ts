...
test.describe('themes: font manager in the Typography section', () => {
  test('the font-add component appears in the theme panel and writes @import', async ({
    window,
    project,
  }) => {
    ...
    const pasteInput = panel.getByPlaceholder(
      /^Paste a Google Fonts or Adobe Fonts embed link/
    );
