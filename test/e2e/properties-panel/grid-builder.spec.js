...
test.describe('properties panel: grid builder', () => {
    ...
    test('quick picker sets equal fr tracks for the chosen size', async ({ window, project, }) => {
        ...
        expect(css).toMatch(new RegExp(`\\.${className}[^}]*grid-template-columns:\\s*1fr 1fr 1fr;`, 's'));
