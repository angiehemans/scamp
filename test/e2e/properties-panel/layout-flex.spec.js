...
test.describe('properties panel: layout / flex', () => {
    test('toggling to Flex emits display:flex and flex controls write CSS', async ({ window, project, }) => {
        ...
        expect(css).toMatch(new RegExp(`\\.${className}[^}]*flex-direction:\\s*column`, 's'));
        // Gap.
