 ...
 */
const highlighted = (window, pane) => window.locator(`[data-pane="${pane}"] [class*="highlightLine"]`);
test.describe('code panel: selection highlight', () => {
    ...
    test('moves to the page root when the background is clicked', async ({ window, }) => {
