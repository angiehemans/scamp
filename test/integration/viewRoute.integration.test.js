...
import { createComponent } from '../../src/main/ipc/componentOps';
/**
...
const make = (name, format) => createComponent({
    projectPath: dir,
    componentName: name,
    kind: 'view',
...
describe('a new view gets a URL in the format the project actually serves', () => {
    ...
    it('leaves an existing route alone rather than overwriting it', async () => {
        ...
        await make('Lobby', 'scamp');
        await fs.writeFile(path.join(dir, 'routes', 'lobby.tsx'), "// hand written\n", 'utf-8');
