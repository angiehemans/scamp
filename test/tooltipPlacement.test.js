...
import { resolveTooltipPlacement, TOOLTIP_GAP, } from '../src/renderer/lib/tooltipPlacement';
describe('resolveTooltipPlacement', () => {
    ...
    it('uses the gap in the room check at the boundary', () => {
        ...
        expect(resolveTooltipPlacement(tipHeight + TOOLTIP_GAP, tipHeight)).toBe('top');
        // One pixel short of the needed room flips to bottom.
        expect(resolveTooltipPlacement(tipHeight + TOOLTIP_GAP - 1, tipHeight)).toBe('bottom');
    });
