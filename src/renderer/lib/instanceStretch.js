 ...
 */
export const instanceStretchStyle = (instanceWidthMode, instanceHeightMode, rootWidthMode, rootHeightMode, parentDisplay, parentDirection) => {
    const widthStretch = instanceWidthMode === 'auto' && rootWidthMode === 'stretch';
    const heightStretch = instanceHeightMode === 'auto' && rootHeightMode === 'stretch';
    if (!widthStretch && !heightStretch)
        return {};
