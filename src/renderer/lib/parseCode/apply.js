 ...
 */
export const applyDeclarationsAsOverride = (decls) => {
    let override = {};
 ...
 */
export const applyDeclarationsAsStateOverride = (decls) => {
...
export const makeRoot = (isComponent = false) => ({
...
export const makeBaseline = (raw, isComponent = false) => {
