 ...
 */
export type AnimationPresetDefaults = Pick<
  ElementAnimation,
  | 'durationMs'
  | 'easing'
  | 'iterationCount'
...
const ENTRANCE_DEFAULTS = {
  ...
  fillMode: 'forwards' as AnimationFillMode,
} satisfies AnimationPresetDefaults;
