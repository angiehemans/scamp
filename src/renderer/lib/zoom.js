 ...
 */
export const stepZoom = (current, direction) => clampZoom(current + direction * ZOOM_BUTTON_STEP);
/**
 ...
 * [MIN_ZOOM, MAX_ZOOM].
 */
export const nextZoomFromWheel = (current, deltaY) => clampZoom(current * Math.exp(-deltaY * ZOOM_SENSITIVITY));
