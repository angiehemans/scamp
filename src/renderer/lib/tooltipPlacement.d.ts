...
export declare const TOOLTIP_GAP = 10;
/**
 ...
 */
export declare const resolveTooltipPlacement: (triggerTop: number, tipHeight: number, preferred?: TooltipPlacement | "auto", gap?: number) => TooltipPlacement;
