...
export const classifyHref = (
  ...
  if (href.startsWith('/')) {
    ...
    if (slug.length === 0) return { kind: 'custom', raw: href };
...
export const pageNameToHref = (pageName: string): string =>
 ...
 * landing in the file.
 */
export const isValidExternalUrl = (raw: string): boolean => {
