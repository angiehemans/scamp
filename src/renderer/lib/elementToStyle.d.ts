import { type FlexDirection, type ScampElement } from "./element";
...
export declare const elementToStyle: (el: ScampElement, parentDisplay: "flex" | "grid" | "none" | undefined, parentDirection: FlexDirection | undefined, tokens: ReadonlyArray<ThemeToken>, projectDir: string | null, projectFormat: "legacy" | "nextjs", isInstanceInner: boolean | undefined, rootMinHeight: number, inComponentEditor?: boolean) => CSSProperties;
/**
