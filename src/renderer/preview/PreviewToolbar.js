...
export const PreviewToolbar = ({ url, statusKind, canGoBack, canGoForward, viewportWidth, pageName, pageNames, onBack, onForward, onReload, onOpenDevTools, onViewportChange, onPageChange, }) => {
