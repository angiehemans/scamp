 ...
 */
export type HistoryActionKind = 'draw-rect' | 'add-text' | 'add-image' | 'add-input' | 'add-component-instance' | 'convert-to-component' | 'detach-instance' | 'load' | 'delete' | 'delete-contents' | 'move' | 'resize' | 'patch' | 'raw-css' | 'rename' | 'rename-page' | 'add-page' | 'delete-page' | 'paste' | 'duplicate' | 'group' | 'ungroup' | 'wrap-link' | 'reorder' | 'toggle-group' | 'external-edit';
/**
