...
], Pick<CanvasState, 'bottomPanel' | 'panelMode' | 'leftSidebarTab' | 'userZoom' | 'fitScale' | 'ratioLocks' | 'exportSettings' | 'canvasMinHeight' | 'setBottomPanel' | 'setPanelMode' | 'setLeftSidebarTab' | 'setExportFormat' | 'setExportPngScale' | 'setCanvasMinHeight' | 'zoomIn' | 'zoomOut' | 'resetZoom' | 'setZoom' | 'setFitScale' | 'toggleRatioLock' | 'clearRatioLock' | 'openThemePanel' | 'setOpenThemePanel'>>;
