...
], Pick<CanvasState, 'bottomPanel' | 'panelMode' | 'sidebarSection' | 'userZoom' | 'fitScale' | 'ratioLocks' | 'exportSettings' | 'canvasMinHeight' | 'setBottomPanel' | 'setPanelMode' | 'setSidebarSection' | 'setExportFormat' | 'setExportPngScale' | 'setCanvasMinHeight' | 'zoomIn' | 'zoomOut' | 'resetZoom' | 'setZoom' | 'setFitScale' | 'toggleRatioLock' | 'clearRatioLock' | 'pendingSvgReload' | 'setPendingSvgReload' | 'openThemePanel' | 'setOpenThemePanel'>>;
