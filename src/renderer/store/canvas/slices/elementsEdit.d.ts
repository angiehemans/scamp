...
], Pick<CanvasState, 'previewAnimation' | 'setPropOverride' | 'clearPropOverride' | 'setElementText' | 'togglePropOnText' | 'renamePropOnText' | 'toggleSlotOnRect' | 'renameSlot' | 'setElementSlotName' | 'moveElement' | 'resizeElement' | 'applyOptimizedImage' | 'patchElement' | 'patchCustomProperties' | 'resetElementFieldsAtBreakpoint' | 'resetElementFieldsAtState' | 'setAnimation' | 'removeAnimation' | 'togglePropertyGroup' | 'playAnimation'>>;
