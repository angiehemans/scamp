...
export const makeCancelWriteTimer = (ctx: SaveContext) => (): void => {
...
export const makeFlushDebouncedWrite = (ctx: SaveContext) => (): void => {
 ...
 * canvas → `diverged`).
 */
export const makeReconcileAfterQuiet = (ctx: SaveContext) => (): void => {
  ...
  if (
    code.tsx === ctx.lastSerializedTsx &&
 ...
 */
export const makeScheduleQuietResume = (ctx: SaveContext) => {
 ...
 * immediately.
 */
export const makeResumeFromPause = (ctx: SaveContext) => (): void => {
