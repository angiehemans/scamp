import { createPatchLog, hunksFor } from '@lib/patchLog';
 ...
 */
export const recordPatch = (target, projectPath, files) => {
    try {
...
try {
    globalThis.__scampPatches = (since = 0) => patchLog.since(since);
}
catch {
