 ...
 */
export const ParseErrorBanner = ({ targetName, reason, onDismiss }) => {
    return (_jsxs("div", { className: styles.banner, role: "alert", children: [_jsxs("div", { className: styles.content, children: [_jsx("span", { className: styles.icon, "aria-hidden": "true", children: "\u26A0" }), _jsxs("div", { className: styles.text, children: [_jsxs("strong", { className: styles.title, children: ["Couldn\u2019t parse \u201C", targetName, "\u201D"] }), _jsx("span", { className: styles.message, children: reason ??
                                    'The canvas is showing the last version that loaded cleanly. Fix ' +
                                        'the file\u2019s syntax, then re-select it to continue editing. ' +
                                        'See the activity log for the error.' })] })] }), _jsx("div", { className: styles.dismissWrap, children: _jsx(Button, { variant: "secondary", size: "sm", onClick: onDismiss, children: "Dismiss" }) })] }));
};
