...
export const CanvasArea = ({ activeComponent, activePageName, projectConfig, artboardScrollRef, onProjectConfigChange, onExitComponentEditor, }) => {
    ...
    return (_jsxs("div", { className: styles.artboard, children: [_jsx("div", { ref: artboardScrollRef, className: styles.artboardScroll, style: { backgroundColor: projectConfig.artboardBackground }, children: _jsxs("div", { className: styles.canvasContent, children: [_jsx(SvgReloadBanner, {}), snapshotPreview !== null && (_jsxs("div", { className: styles.snapshotPreviewBanner, "data-testid": "snapshot-preview-banner", children: [_jsxs("span", { children: ["Previewing snapshot:", ' ', _jsx("strong", { children: snapshotPreview.label }), ". The canvas is read-only \u2014 restoring replaces all project files."] }), _jsxs("div", { className: styles.snapshotPreviewActions, children: [_jsx("button", { type: "button", className: styles.snapshotPreviewRestore, onClick: handleRestorePreview, children: "Restore" }), _jsx("button", { type: "button", className: styles.snapshotPreviewExit, onClick: handleExitPreview, children: "Exit" })] })] })), activeComponent !== null && (_jsxs("div", { className: styles.componentEditorBanner, "data-testid": "component-editor-banner", children: [_jsx("span", { children: activeComponent.kind === 'view' ? (_jsxs(_Fragment, { children: ["Editing view: ", _jsx("strong", { children: activeComponent.name }), "."] })) : (_jsxs(_Fragment, { children: ["Editing component:", ' ', _jsx("strong", { children: activeComponent.name }), ". Changes affect all instances."] })) }), _jsx("button", { type: "button", className: styles.componentEditorExit, onClick: onExitComponentEditor, children: "Exit" })] })), _jsxs("div", { className: styles.canvasHeader, children: [activeComponent !== null ? (
                                ...
                                _jsxs("div", { className: styles.canvasHeaderBadge, role: "navigation", "aria-label": "Component editor breadcrumb", children: [activeComponent.returnToPage !== null && (_jsxs(_Fragment, { children: [_jsx("button", { type: "button", className: styles.canvasBreadcrumbLink, onClick: onExitComponentEditor, children: activeComponent.returnToPage }), _jsx("span", { "aria-hidden": "true", children: ' › ' })] })), _jsx("button", { type: "button", className: styles.canvasBreadcrumbCurrent, onClick: () => useCanvasStore
                                                .getState()
                                                .selectElement(ROOT_ELEMENT_ID), title: `Select ${activeComponent.kind} root`, children: activeComponent.name })] })) : (_jsx("button", { type: "button", className: styles.canvasHeaderBadge, onClick: () => useCanvasStore
                                        .getState()
