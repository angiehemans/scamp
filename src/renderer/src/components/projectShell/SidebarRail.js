...
export const SidebarRail = ({ section, onSelectSection, onOpenDesignSystem, onOpenSettings, designSystemOpen, settingsOpen, }) => {
    ...
    return (_jsxs("nav", { className: styles.rail, "aria-label": "Sections", "data-testid": "sidebar-rail", children: [railButton('pages', 'Pages', _jsx(IconFiles, { size: ICON_SIZE }), section === 'pages', () => onSelectSection('pages')), railButton('components', 'Components', _jsx(IconComponents, { size: ICON_SIZE }), section === 'components', () => onSelectSection('components')), railButton('design-system', 'Design System', _jsx(IconPalette, { size: ICON_SIZE }), designSystemOpen, onOpenDesignSystem), railButton('history', 'History', _jsx(IconHistory, { size: ICON_SIZE }), section === 'history', () => onSelectSection('history')), railButton('settings', 'Settings', _jsx(IconSettings, { size: ICON_SIZE }), settingsOpen, onOpenSettings)] }));
};
