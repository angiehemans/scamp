 ...
 */
export const ThemeSectionNav = (): JSX.Element => {
  ...
  const go = (id: ThemeSectionId): void => {
    setActive(id);
  ...
  return (
    <nav className={styles.nav} data-testid="theme-section-nav" aria-label="Theme sections">
