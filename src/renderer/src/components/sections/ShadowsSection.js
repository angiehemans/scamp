 ...
 */
const ShadowColorRow = ({ color, elementId, onChange, projectColors, themeTokens, onOpenTheme, }) => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(ColorInput, { value: color, onChange: handleColorChange, historyElementId: elementId, historyPropertyKey: "boxShadows", presetColors: projectColors.length > 0 ? projectColors : undefined, tokens: themeTokens, onOpenTheme: onOpenTheme, disableAlpha: true }), _jsx(NumberInput, { prefix: "O", suffix: "%", title: split.decomposable
