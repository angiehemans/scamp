...
export const LayoutSection = ({ elementId }) => {
    ...
    return (_jsxs(Section, { title: "Layout", elementId: elementId, fields: [
            ...
            'row-gap',
            'justify-items',
        ], children: [_jsx(Row, { label: "", children: _jsx(SegmentedControl, { value: mode, options: LAYOUT_OPTIONS, onChange: (value) => patchElement(elementId, computeLayoutPatch(element, value)), title: "Display mode" }) }), isFlex && (_jsxs(_Fragment, { children: [_jsxs(Row, { label: "", children: [_jsx(EnumSelect, { value: element.alignItems, options: ALIGN_OPTIONS, onChange: (value) => patchElement(elementId, { alignItems: value }), title: "Align items" }), _jsx(EnumSelect, { value: element.justifyContent, options: JUSTIFY_OPTIONS, onChange: (value) => patchElement(elementId, { justifyContent: value }), title: "Justify content" })] }), _jsx(Row, { label: "", children: _jsx(SpaceValueInput, { prefix: "Gap", title: "Gap between flex children", value: element.gap, onChange: (value) => patchElement(elementId, { gap: value }), min: 0, tokens: spacingTokens, ...(openThemePanel ? { onOpenTheme: openThemePanel } : {}) }) })] })), isGrid && (_jsxs(_Fragment, { children: [_jsx(Row, { label: "", children: _jsx(PrefixSuffixInput, { prefix: "Cols", title: "grid-template-columns", value: element.gridTemplateColumns, placeholder: "1fr 1fr", onCommit: (value) => patchElement(elementId, { gridTemplateColumns: value.trim() }) }) }), _jsx(Row, { label: "", children: _jsx(PrefixSuffixInput, { prefix: "Rows", title: "grid-template-rows", value: element.gridTemplateRows, placeholder: "auto", onCommit: (value) => patchElement(elementId, { gridTemplateRows: value.trim() }) }) }), _jsxs(Row, { label: "", children: [_jsx(SpaceValueInput, { prefix: "C-gap", title: "column-gap", value: element.columnGap, onChange: (value) => patchElement(elementId, { columnGap: value }), min: 0, tokens: spacingTokens, ...(openThemePanel ? { onOpenTheme: openThemePanel } : {}) }), _jsx(SpaceValueInput, { prefix: "R-gap", title: "row-gap", value: element.rowGap, onChange: (value) => patchElement(elementId, { rowGap: value }), min: 0, tokens: spacingTokens, ...(openThemePanel ? { onOpenTheme: openThemePanel } : {}) })] }), _jsxs(Row, { label: "", children: [_jsx(EnumSelect, { value: element.alignItems, options: ALIGN_OPTIONS, onChange: (value) => patchElement(elementId, { alignItems: value }), title: "Align items" }), _jsx(EnumSelect, { value: element.justifyItems, options: GRID_SELF_OPTIONS, onChange: (value) => patchElement(elementId, { justifyItems: value }), title: "Justify items" })] })] }))] }));
};
