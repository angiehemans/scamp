      ...
      return _jsxs("div", {
        ...
        children: [
          _jsx("h2", {
            ...
            children: "Welcome to Scamp",
          }),
          _jsx("p", {
            className: styles.welcomeText,
            children:
              "Pick a default folder where new projects will live. Each project gets its own subfolder inside it. You can change this later.",
          }),
          _jsx("button", {
      ...
      children: [
        ...
        recents.length === 0
          ? _jsx("div", {
              ...
              children: "No recent projects yet.",
            })
          : _jsx("ul", {
                    ...
                    children: [
                      _jsxs("button", {
                        ...
                        children: [
                          ...
                          _jsx("span", {
                            className: styles.recentPath,
                            children: recent.path,
                          }),
                          !recent.exists &&
                            _jsx("span", {
  ...
  return _jsxs("div", {
    ...
    children: [
      _jsxs("aside", {
        ...
        children: [
          _jsx("h1", { className: styles.sidebarTitle, children: "Scamp" }),
          _jsx("p", {
            className: styles.sidebarSubtitle,
            children: "Local design tool \u2014 draw, get real code.",
          }),
          _jsxs("div", {
          ...
          _jsx("div", { className: styles.sidebarSpacer }),
          _jsxs("div", {
      ...
      _jsx("main", { className: styles.main, children: renderMain() }),
      showCreateModal &&
        defaultFolder &&
        _jsx(CreateProjectModal, {
