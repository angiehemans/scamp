import { useCanvasStore, type PanelMode } from '@store/canvasSlice';
import { SegmentedControl } from './controls/SegmentedControl';
import styles from './PropertiesPanel.module.css';

const PAGE_OPTIONS: ReadonlyArray<{ value: PanelMode; label: string }> = [
...
export const PanelModeToggle = (): JSX.Element => {
  ...
  const hasInstancePropToShow = useCanvasStore((s) => {
    ...
    if (!el || el.type !== 'component-instance') return false;
