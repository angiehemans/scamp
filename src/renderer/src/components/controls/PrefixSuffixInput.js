 ...
 * as "draft reverts".
 */
export const PrefixSuffixInput = ({ value, onCommit, onDraftChange, prefix, dataPrefix, suffix, flushPrefix = false, placeholder, inputMode = 'text', title, disabled = false, onArrow, stopKeyPropagation = false, inputRef, inputClassName, spellCheck = false, autoCapitalize, autoCorrect, computed = false, }) => {
    ...
    const prefixAttr = dataPrefix ?? (typeof prefix === 'string' ? prefix : undefined);
