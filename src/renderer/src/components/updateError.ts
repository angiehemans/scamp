 ...
 */
export const describeUpdateError = (raw: string): string => {
  ...
  if (
    /enotfound|etimedout|econnrefused|econnreset|getaddrinfo|enetunreach|eai_again|net::|offline|connection|socket|dns/.test(
      lower
    )
  ) {
