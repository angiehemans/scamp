...
export const SentryOptInPrompt = ({ onDecision }) => {
    ...
    return (_jsx("div", { className: styles.backdrop, children: _jsxs("div", { className: styles.dialog, role: "dialog", "aria-modal": "true", "aria-labelledby": "sentry-opt-in-title", children: [_jsx("h2", { id: "sentry-opt-in-title", className: styles.title, children: "Help improve Scamp" }), _jsx("p", { className: styles.message, children: "Send anonymous crash reports, plus a count of app launches so we know how many people use Scamp. No personal data, no project files, no file contents \u2014 only error details, your OS and app version, and a random ID that identifies this install and nothing else." }), _jsx("p", { className: styles.messageSecondary, children: "You can change this at any time in Settings." }), _jsxs("div", { className: styles.actions, children: [_jsx(Button, { variant: "ghost", onClick: () => onDecision(false), children: "No thanks" }), _jsx(Button, { variant: "primary", onClick: () => onDecision(true), autoFocus: true, children: "Send anonymous data" })] })] }) }));
};
