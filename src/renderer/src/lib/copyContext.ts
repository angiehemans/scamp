...
const targetOf = (state: ReturnType<typeof useCanvasStore.getState>):
  ContextTarget | null => {
...
export const currentContextString = (): string => {
...
export const copyContextToClipboard = async (): Promise<boolean> => {
  try {
