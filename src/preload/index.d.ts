...
declare const api: {
    ...
    writeProjectThumbnail: (args: ProjectWriteThumbnailArgs) => Promise<ProjectWriteThumbnailResult>;
    readProjectThumbnail: (args: ProjectReadThumbnailArgs) => Promise<ProjectReadThumbnailResult>;
