...
export const thumbnailPathFor = (projectPath) => join(projectPath, '.scamp', FILE_NAME);
/**
...
export const writeProjectThumbnail = async (args) => {
    try {
...
export const readProjectThumbnail = async (args) => {
    try {
...
export const hasProjectThumbnail = async (projectPath) => {
    try {
