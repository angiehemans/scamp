 ...
 */
export const parseTpgid = (statContent) => {
 ...
 */
export const readProcessName = async (pid) => {
    try {
 ...
 */
export const readForeground = async (shellPid, shellBaseName) => {
    let statContent;
    try {
