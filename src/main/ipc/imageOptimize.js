 ...
 */
const encodeSmaller = async (input, sourceSize) => {
    let candidates;
    try {
        ...
        const open = () => sharp(input, { failOn: 'none' });
 ...
 */
export const bufferToWebpIfSmaller = async (data) => encodeSmaller(data, data.length);
