 ...
 */
const cache = new Map<string, ProjectFormat>();

export const setCachedProjectFormat = (
  projectPath: string,
...
export const clearCachedProjectFormat = (projectPath: string): void => {
 ...
 */
export const getProjectFormat = async (
  projectPath: string
): Promise<ProjectFormat> => {
