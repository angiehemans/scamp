...
export const isValidInstallId = (value) => typeof value === 'string' && UUID_V4.test(value);
/**
 ...
 */
export const resolveInstallId = (settings) => {
 ...
 */
export const installIdForConsent = (settings, optedIn) => (optedIn ? resolveInstallId(settings) : null);
