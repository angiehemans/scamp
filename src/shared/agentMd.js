 ...
 */
export const defaultPageTsx = (componentName, moduleName, cssModuleImportName = moduleName) => {
 ...
 * later.
 */
export const LEGACY_LAYOUT_TEMPLATES = (projectName) => [
 ...
 */
export const defaultPackageJson = (projectName) => {
    const data = {
        name: projectName,
        version: '0.1.0',
        private: true,
