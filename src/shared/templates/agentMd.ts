...
export const AGENT_MD_CONTENT_SCAMP = AGENT_MD_CONTENT.replace(
  ...
  /In this project each view previews through a[\s\S]*?never edit it\./,
  'There are no wrapper pages here: a page is its view, and the route that renders it lives in `routes/`, which is yours.'
);
